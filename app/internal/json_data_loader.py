...
def load_json_data_to_database(session) -> None:
...
def _save_to_database(session: Session, path: str, table: Base,
                      model_creator: Callable) -> bool:
    """Saves the extracted JSON data into the database.
